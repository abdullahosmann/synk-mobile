...
**Remaining (not started), per UIUX_AUDIT.md:** F8 (deferred), B4 long-tail icon buttons (decorative/per-card: rest-log sheet X, builder controls, calendar day cells), P4 (dead voice-log states — harmless until a real recognizer). Android build still blocked (no toolchain).
